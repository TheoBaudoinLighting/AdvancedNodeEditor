...
namespace NodeEditorCore {
    ...
    inline NodeLabelPosition convertToNodeLabelPosition(NodeLabelPosition p) { return static_cast<NodeLabelPosition>(p); }
    ...
    inline NodeLabelPosition convertToANENodeLabelPosition(NodeLabelPosition p) { return static_cast<NodeLabelPosition>(p); }
