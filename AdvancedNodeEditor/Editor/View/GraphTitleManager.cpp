...
namespace NodeEditorCore {
    ...
    ImVec2 GraphTitleManager::calculateTitlePosition(const ImVec2 &canvasPos, const ImVec2 &canvasSize,
    ...
    void GraphTitleManager::drawTitleBackground(ImDrawList *drawList, const ImVec2 &pos, const ImVec2 &size) {
        ...
        switch (m_config.style) {
            case TitleStyle::Default:
                ...
                drawList->AddRect(pos, ImVec2(pos.x + size.x, pos.y + size.y), borderColor, cornerRadius, 0,
                                  borderThickness);
                break;
            ...
            case TitleStyle::FilledTransparent:
                cornerRadius = 5.0f; {
                    ...
                    drawList->AddRectFilled(pos, ImVec2(pos.x + size.x, pos.y + size.y), transparentBgColor,
                                            cornerRadius);
                }
                break;
