...
namespace NodeEditorCore {
    ...
    public:
        ...
        int addPin(int nodeId, const std::string &name, bool isInput,
                   NodeEditorCore::PinType type = NodeEditorCore::PinType::Blue,
                   NodeEditorCore::PinShape shape = NodeEditorCore::PinShape::Circle);
