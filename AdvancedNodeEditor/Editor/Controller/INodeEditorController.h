...
namespace NodeEditorCore {
    ...
    public:
        ...
        virtual int addPin(int nodeId, const std::string &name, bool isInput, PinType type = PinType::Blue,
                           PinShape shape = PinShape::Circle) = 0;
        ...
        virtual void updateConnection(int connectionId,
                                      const std::function<void(NodeEditorModel::Connection &)> &updateFn) = 0;
